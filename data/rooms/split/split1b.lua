function init()
	...
	confSegment("split/split1/16_0", 1)
	confSegment("split/split1/16_1", 1)
	confSegment("split/split1/16_2", 1)
	confSegment("split/split1/16_3", 1)
	confSegment("split/split1/16_4", 1)
	confSegment("split/split1/16_5", 1)
	confSegment("split/split1/16_6", 1)
	...
	l = l + mgSegment("split/split1/16_0", -l)	
